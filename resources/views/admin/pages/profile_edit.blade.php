        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <br><br>
                    <form class="form-horizontal" role="form" action="{{ route('profile.edit.post') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10 {{ $errors->has('image') ? 'has-error' : '' }}">
                                @if(Auth::user()->user_image !=null && file_exists('assets/images/users/'.Auth::user()->user_image))
                                    <img src="{{ asset('assets/images/users/'.Auth::user()->user_image) }}" width="70" height="70">
                                @else
