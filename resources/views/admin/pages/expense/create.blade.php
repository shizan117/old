            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-20">
                                <form class="form-horizontal" role="form" action="{{ route('expanse.add.post') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 {{ $errors->has('expanse_name') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="expanse_name" value="{{ old('expense_name') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4 {{ $errors->has('expanse_category') ? 'has-error' : '' }}">
                                            <select class="form-control" name="expanse_category" required>
                                                ...
                                                @foreach($cats as $cat)
                                                    <option value="{{ $cat->id}}" {{ (collect(old('expanse_category'))->contains($cat['id'])) ? 'selected':'' }}>{{$cat->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-group col-4 {{ $errors->has('expense_date') ? 'has-error' : '' }}">
                                            <input type="text" autocomplete="off" name="expense_date" class="form-control"
                                                   ...
                                                   id="datepicker" value="{{ old('expense_date')??date('Y-m-d') }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4 {{ $errors->has('amount') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="amount" value="{{ old('amount') }}" placeholder="Enter Expanse Amount" required>
                                   ...
                                   <div class="form-group mb-0 justify-content-end row">
                                        <div class="col-10">
                                            <button type="submit" class="btn btn-info waves-effect waves-light">Add Expanse</button>
