            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-20">
                                <form class="form-horizontal" role="form" action="{{ route('expanse.cat.edit.post', $cat->id) }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 {{ $errors->has('expanse_category_name') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="expanse_category_name" value="{{ $cat->name }}" placeholder="Enter Expanse Category Name">
