            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-20">
                                <form class="form-horizontal" role="form" action="{{ route('branch.add.post') }}" method="POST">

                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Branch Name</label>
                                        <div class="col-10 {{ $errors->has('branchName') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="branchName" value="" placeholder="Enter Branch Name">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 {{ $errors->has('branchLocation') ? 'has-error' : '' }}">
                                            <textarea class="form-control" name="branchLocation" ></textarea>
                                    ...
                                    <div class="form-group mb-0 justify-content-end row">
                                        <div class="col-10">
                                            <button type="submit" class="btn btn-info waves-effect waves-light">Add Branch</button>
