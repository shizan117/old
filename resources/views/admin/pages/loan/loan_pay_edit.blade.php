            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-20">
                                <form class="form-horizontal" role="form" action="{{ route('loan.pay.edit.post', $loan->id) }}" method="POST">

                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Loan Add To Account</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 {{ $errors->has('pay_amount') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="pay_amount" value="{{ $loan->pay_amount }}" placeholder="Enter Pay Amount">
