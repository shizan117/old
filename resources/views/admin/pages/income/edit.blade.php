            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-20">
                                <form class="form-horizontal" role="form" action="{{ route('income.edit.post', $income->id) }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 {{ $errors->has('income_name') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="income_name" value="{{ $income->name }}" placeholder="Enter Income Title" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4 {{ $errors->has('income_category') ? 'has-error' : '' }}">
                                            <select class="form-control" name="income_category" required>
                                                ...
                                                @foreach($cats as $cat)
                                                    <option value="{{ $cat->id}}" {{ ($income->cat_id == $cat->id) ? 'selected':'' }}>{{$cat->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-group col-4 {{ $errors->has('income_date') ? 'has-error' : '' }}">
                                            <input type="text" autocomplete="off" name="income_date" class="form-control"
                                                   ...
                                                   id="datepicker" value="{{ $income->date }}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4 {{ $errors->has('amount') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="amount" value="{{ $income->amount }}" placeholder="Enter Income Amount" required>
                                        ...
                                        <div class="col-4 {{ $errors->has('account') ? 'has-error' : '' }}">
                                            <select class="form-control" name="account" required>
                                                ...
                                                @foreach($accounts as $account)
                                                    <option value="{{ $account->id}}" {{ ($income->transaction->account->id == $account->id) ? 'selected':'' }}>{{$account->account_name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10 {{ $errors->has('note') ? 'has-error' : '' }}">
                                            <textarea name="note" cols="30" rows="4" class="form-control"
                                                      placeholder="Note additional information">{{ $income->note }}</textarea>
                                   ...
                                   <div class="form-group mb-0 justify-content-end row">
                                        <div class="col-10">
                                            <button type="submit" class="btn btn-info waves-effect waves-light">Update Income</button>
