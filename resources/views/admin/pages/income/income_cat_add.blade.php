            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-20">
                                <form class="form-horizontal" role="form" action="{{ route('income.cat.add.post') }}" method="POST">

                                    {{ csrf_field() }}
                                    <div class="form-group row">
                                        <label class="col-3 col-form-label">Income Category Name</label>
                                        <div class="col-9 {{ $errors->has('income_category_name') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" name="income_category_name" value="" placeholder="Enter Income Category Name">
