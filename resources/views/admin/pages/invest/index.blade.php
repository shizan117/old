        ...
        <div class="col-12">
            <div class="card-box table-responsive">
                ...
                <div class="btn-group m-b-10">
                    <div class="btn-group m-b-10">
                        <a href="{{ route('invest.add') }}" class="btn btn-primary">Add Invest</a>
                    </div>
                </div>
                ...
                <table id="datatable"
                    ...
                    @foreach ($invests as $invest)
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>{{ date("d-M-Y", strtotime($invest->date)) }}</td>
                            <td class="text-right">{{ $invest->amount }}</td>
                            <td>{{ $invest->investor->name }}</td>
                            <td>{{ $invest->user->name }}</td>
                            <td class="hidden-print">

                                <a href="{{ route('invest.edit', $invest->id) }}" class="btn-edit"><i
